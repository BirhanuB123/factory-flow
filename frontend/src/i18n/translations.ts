...
const STRINGS = pack({
  ...
  "auth.emailOrIdPlaceholder": { en: "you@company.com or EMP-001", am: "you@company.com ወይም EMP-001", om: "you@company.com ykn EMP-001" },
  "auth.password": { en: "Password", am: "የይለፍ ቃል", om: "Jecha icciitii" },
  "auth.passwordPlaceholder": { en: "Enter your password", am: "የይለፍ ቃልዎን ያስገቡ", om: "Jecha icciitii kee galchi" },
  ...
  "dashboard.moduleHr": { en: "HRM", am: "HR እና ደሞዝ", om: "HR fi kaffaltiwwan" },
  "dashboard.moduleCrm": { en: "CRM & Customers", am: "CRM እና ደንበኞች", om: "CRM fi maamiltootaa" },
  "dashboard.modulePos": { en: "Point of Sale", am: "የሽያጭ ቦታ", om: "Bakka gurgurtaa" },
  "dashboard.moduleGlobalTrade": { en: "Global Trade", am: "አለምአቀፍ ንግድ", om: "Daldalaa addunyaa" },
  "dashboard.moduleAnalytics": { en: "Analytics", am: "ትንታኔ", om: "Xiinxala" },
  ...
  "pages.hr.title": { en: "HRM", am: "ሰው ሀብት እና ደሞዝ", om: "HR fi kaffaltiwwan" },
  "pages.hr.subtitle": {
  ...
  "pages.myHr.title": { en: "My HRM", am: "የኔ ሰው ሀብት", om: "HR koo" },
  "pages.myHr.subtitle": {
